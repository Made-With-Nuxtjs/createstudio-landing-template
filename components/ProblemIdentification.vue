                ...
                <div class="flex-col space-y-8">
                    <p class="text-2xl">
                        To <span class="font-bold">easily create 3D animated videos</span> in <span
                            class="underline">under 10mins</span> for your;
                    </p>
                    <p class="text-2xl">
                        Website, sales funnels and social media...
                    </p>
                    <p class="text-2xl">
                        Where the hard work was <span class="font-bold">ALREADY</span> done for you...
                    </p>
                    <p class="text-2xl">
                        With <span class="font-bold">1000’s of pre-built animations & pre-rigged characters</span> <span
                            class="underline">designed by PIXAR trained experts...</span>
                    </p>
                    <p class="text-2xl">
                        So all you had to do was <span class="underline">simply drag & drop?</span>
                    </p>
                </div>
                <div>
